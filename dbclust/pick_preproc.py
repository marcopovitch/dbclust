...
if __name__ == "__main__":
    ...
    csv_file_out = (
        "/Users/marc/Data/DBClust/france.2016.01/picks/france-2016.01-filtered-P_0.1-S_0.2.picks"
    )
    P_delta_time = 0.1
    S_delta_time = 0.2
    unload_too_close_picks_clustering(csv_file_in, csv_file_out, P_delta_time, S_delta_time)
